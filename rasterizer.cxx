...
// Modified ceil function to prevent rounding differences between machines
double ceil_441(double f)
{
    return ceil(f-0.00001);
}

// Modified floor function to prevent rounding differences between machines
...
// Helper function for determining camera position, from project starter code
...
// Get a set of triangles from a .vtk file, from project starter code
std::vector<Triangle>
GetTriangles(void)
{
...
// Camera parameters are hard-coded to meet project specifications
Camera
